...
import FlightDateRangeInput from "./ActivityDateRangeInput";
...
export type TypeDropOffLocationType = "lorem 1" | "lorem 2" | "";
const FlightSearchForm: FC<FlightSearchFormProps> = ({ hasButtonSubmit = true }) => {
  const [dropOffLocationType, setDropOffLocationType] =
    useState<TypeDropOffLocationType>("lorem 1");
  const [flightClassState, setFlightClassState] = useState("Adventure");
