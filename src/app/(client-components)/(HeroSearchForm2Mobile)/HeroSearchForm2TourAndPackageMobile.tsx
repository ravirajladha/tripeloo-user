...
import TourAndPackageSearchForm from './(tour-and-package-search-form)/TourAndPackageSearchForm'

const HeroSearchForm2TourAndPackageMobile = () => {
	...
	return (
		<div className="HeroSearchForm2TourAndPackageMobile">
...
export default HeroSearchForm2TourAndPackageMobile
