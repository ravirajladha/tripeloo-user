...
export interface StayDatesRangeInputProps {
  className?: string;
  onChange: (dates: [Date | null, Date | null]) => void;  // ✅ Accept callback
}

const StayDatesRangeInput: FC<StayDatesRangeInputProps> = ({ className = "flex-1", onChange }) => {
  ...
  const onChangeDate = (dates: [Date | null, Date | null]) => {
    ...
    setEndDate(dates[1]);
    onChange(dates);  // ✅ Pass updated dates to parent component
  };
  const renderInput = () => {
    return (
      <>
