...
const DEMO_DATA = [
  {
    ...
    clientAddress: "Wayanad",
    content:
      "This place is exactly like the picture posted on Tripeloo. Great service, we had a great stay!",
  },
  {
    id: 2,
...
const SectionClientSay: FC<SectionClientSayProps> = ({
  ...
  return (
    <div className={`nc-SectionClientSay relative ${className} `}>
      <Heading desc="Let's see what people think of Tripeloo" isCenter>
